...
- **Highlight Synchronization** – Orient quickly between layers by highlighting any block or code line and view the corresponding elements highlight.
...
| Feature                  | **GLANCER** | **BVD4B** | **NuzzleBug** |
|--------------------------|------------|--------------|----------|
...
3. **Highlight Syncing** - Highlights set in Blockly automatically sync to corresponding source-line-of-code (SLOC) and vice versa.
...
4. **Breakpoints** - Set breakpoints on blocks or source code lines.
